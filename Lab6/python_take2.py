...
class Node:
    def __init__(self, name):
        ...
        self.Level = -1  # Adding Level attribute to Node
...
def read_circuit(filename):
    ...
    # Set level 0 for nodes in input_wires and dff_outputs
...
def print_circuit(gate_list):
    ...
    while current:
        ...
        print(f"Gate: {current.GateName}, Type: {current.GateType}, Fanout: {fanout_name}, Fanin: {fanin_names}")
        current = current.next
